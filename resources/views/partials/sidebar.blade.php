<header>
    ...
    <ul class="list-inline">
        <li><a href="{{url('/')}}/language/en">{{ trans('general.en-language') }}</a></li>
        <li><a href="{{url('/')}}/language/tr">{{ trans('general.tr-language') }}</a></li>
        <li><a href="{{url('/')}}/language/fa">{{ trans('general.fa-language') }}</a></li>
    </ul>
</header>
<nav id="nav">
    @yield('menus')
